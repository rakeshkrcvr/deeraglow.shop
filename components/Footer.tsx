...
export default function Footer() {
  ...
  const [instagramUrl, setInstagramUrl] = React.useState('https://www.instagram.com/deeraglowshop/');
  const [facebookUrl, setFacebookUrl] = React.useState('https://www.facebook.com/profile.php?id=61592384944285');
  const [pinterestUrl, setPinterestUrl] = React.useState('https://in.pinterest.com/deekshadeeraglow/');
  ...
  React.useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        if (settings.pinterestUrl) setPinterestUrl(settings.pinterestUrl);
      } catch (err) {
      ...
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.socials}>
            ...
            <a href={facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.socialLink}>
