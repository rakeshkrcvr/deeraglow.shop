...
export const fallbackProductsList: Product[] = [
  {
    id: 1,
    ...
    acc_ingredients: "925 Sterling Silver base, 18k gold plating, AAA+ cubic zirconia, skin-friendly and completely lead and nickel free.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals. Clean gently with a dry microfibre cloth.",
    acc_shipping: "Free standard shipping on orders over ₹999. Deliveries take 3-5 working days."
  },
  {
    id: 2,
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "Adjustable Ring Size",
    weight: "12 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, 18k gold plating, AAA+ cubic zirconia, skin-friendly and completely lead and nickel free.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    id: 3,
    ...
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, 18k gold plating, AAA+ cubic zirconia.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "7 inch + 1 inch extension",
    weight: "16 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, 18k gold plating, AAA+ cubic zirconia.",
  ...
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "Standard Charm Size",
    weight: "8 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, AAA+ cubic zirconia.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
  ...
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "Standard Stud Size",
    weight: "10 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, 18k rose gold plating, AAA+ cubic zirconia.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    ...
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, AAA+ emerald crystal.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "16 inch + 2 inch extension",
    weight: "18 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, 18k gold plating.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "Standard Bangle Size",
    weight: "22 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base.",
    acc_instructions: "Avoid direct contact with water, sweat, perfumes, or harsh chemicals.",
    acc_shipping: "Free standard shipping on orders over ₹999."
  },
  {
    ...
    tagline: "100% tarnish-free — 925 sterling silver — premium cubic zirconia",
    fragrances: "925 Sterling Silver, Gold Plated, Cubic Zirconia",
    dimensions: "Standard Huggie Size",
    weight: "10 gms",
    burn_hours: "N/A",
    acc_burn_time: "Tarnish-free polish lifetime durability",
    acc_ingredients: "925 Sterling Silver base, AAA+ cubic zirconia.",
...
function getCategoryFallbackImage(collection: string): string {
  const c = (collection || '').toLowerCase();
  if (c.includes('ring')) return '/images/rings_category.png';
  if (c.includes('necklace') || c.includes('choker') || c.includes('pendant')) return '/images/necklaces_category.png';
  if (c.includes('earring') || c.includes('stud') || c.includes('drop') || c.includes('hoop')) return '/images/earrings_category.png';
  if (c.includes('bracelet') || c.includes('bangle') || c.includes('cuff')) return '/images/bracelets_category.png';
  if (c.includes('charm')) return '/images/charm_category.png';
  return '/images/category_banner_jewelry.png';
}
...
export async function getProducts(options: { includeDeleted?: boolean } = {}): Promise<Product[]> {
  try {
    ...
    for (const prod of fallbackProductsList) {
    ...
    const sanitizedProducts = allProducts.map(p => ({
      ...p,
      image_url: (p.image_url && p.image_url.trim() !== '') ? p.image_url : getCategoryFallbackImage(p.collection),
    ...
    const result = options.includeDeleted ? sanitizedProducts : sanitizedProducts.filter(product => !product.deleted_at);

    if (result.length > 0) {
      return result;
    }
  } catch (error) {
    console.error("Database connection/query error in getProducts, using fallback list:", error);
  }

  // Guaranteed non-empty fallback so no section is ever blank
  return fallbackProductsList;
}
