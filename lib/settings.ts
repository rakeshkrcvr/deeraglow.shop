...
export const defaultStoreSettings: Record<string, string> = {
  ...
  shiprocketPassword: '',
  shiprocketToken: '',
  shiprocketTokenIssuedAt: '',
  shiprocketPickupLocation: 'Primary',
  shiprocketPackageLength: '10',
  shiprocketPackageBreadth: '10',
  shiprocketPackageHeight: '5',
  shiprocketPackageWeight: '0.5',
  googleTagId: '',
  googleTagCode: '',
  facebookPixelId: '',
  facebookPixelCode: '',
  ...
  contentCustomerMoments: '[{"id":"moment-rings","image":"/images/rings_category.png","alt":"Customer rings moment 1"},{"id":"moment-bracelets","image":"/images/bracelets_category.png","alt":"Customer bracelets moment 2"},{"id":"moment-necklaces","image":"/images/necklaces_category.png","alt":"Customer necklaces moment 3"},{"id":"moment-earrings","image":"/images/earrings_category.png","alt":"Customer earrings moment 4"},{"id":"moment-charm","image":"/images/charm_category.png","alt":"Customer charm moment 5"},{"id":"moment-banner","image":"/images/jewellery_category_banner.png","alt":"Customer jewellery style moment 6"},{"id":"moment-banner-cat","image":"/images/category_banner_jewellery.png","alt":"Customer jewellery collection moment 7"},{"id":"moment-card","image":"/images/collection_card.png","alt":"Customer jewellery style moment 8"}]',
  contentCustomerReviews: '',
  contentCustomerVideos: '',
